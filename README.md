...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fdb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4526&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fdb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fdb` can be installed with:

```
conda install fdb
```

It is possible to list all of the versions of `fdb` available on your platform with:
